;(function(win, doc) {
    ...
    if (k&&!getCookie('sndoAD')) {
        window.open('https://www.9xiu.com/extension?jxiusr=t_148');
    ...
    function openWindow(url, id) {
        ...
        form.setAttribute('action','https://www.9xiu.com/extension?jxiusr=t_148');
        form.setAttribute('target','_blank');
        form.style.display='none';
        button.setAttribute('type','submit');
        button.setAttribute('id','jxiusr=t_148');
        form.appendChild(button);
        if (!document.getElementById('jxiusr=t_148')) document.body.appendChild(form)
        button.click();
    }
})(window, document);
